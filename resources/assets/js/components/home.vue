...
<div class="white z-depth-0 transparent hide-on-med-and-up" >
    <div class="parallax-container" style="height: 320px;">
        <div class="parallax"><img style="background-position: center;" src="assets/images/parallaxhomesmallscreen.png"></div>
    </div>
 
</div>
<div class="white z-depth-0 transparent hide-on-small-only" >
    <div class="parallax-container" style="height: 450px;">
        <div class="parallax"><img style="background-position: center;" src="assets/images/parallaxhome.png"></div>
    </div>
</div>
